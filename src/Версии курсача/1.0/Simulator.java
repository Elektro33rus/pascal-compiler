...
public class Simulator {
    ...
    private static void less() {
        ...
        String temp = giveMeIfElseVar();
        
        AllProgram+="%ifcond"+temp+" = icmp slt i32 %"+t1+", i32 %"+t2+"\n" + 
        		"br i1 %ifcond"+temp+", label %then, label %else\n";
    ...
    public static void mult(){
        ...
        stackNumber.add(alloca);
        AllProgram+="%"+alloca+" = mul i32 %"+t1+", %"+t2+"\n";
        stack.push(val1 * val2);
    }
    ...
    private static String giveMeIfElseVar() {
    	String temp="";
    	KolvoIfElse++;
    	temp=Integer.toString(KolvoIfElse);
    	return temp;
    }
    
    private static int KolvoVar=0;
    private static int KolvoIfElse=0;
    private static String AllProgram="define i32 @main() {\nentry:\n";
    ...
    public static void pushi(){
        ...
        AllProgram+="store i32 " + val +", i32* %"+alloca+"\n";
        AllProgram+="%"+load+" = load i32, i32* %"+alloca+"\n";
    ...
    public static void push(){
        ...
        String load = giveMeNumberVar();
        AllProgram+="%"+alloca+" = alloca i32\n";
        AllProgram+="store i32 " + getData(dp) +", i32* %"+alloca+"\n";
        AllProgram+="%"+load+" = load i32, i32* %"+alloca+"\n";
        stackNumber.push(load);
        stack.push(getData(dp));
    }
