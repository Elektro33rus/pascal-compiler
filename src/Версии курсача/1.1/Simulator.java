...
public class Simulator {
    ...
    public static void printInt(){
    	...
    	AllProgram+="%"+temp+" = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 %"+test+")\n";
    ...
    public static void add(){
        ...
        AllProgram+="%"+alloca+" = add i32 %"+t1+", %"+t2+"\n";
    ...
    public static void sub(){
        ...
        String t1 = (String) stackNumber.pop();
        String alloca = giveMeNumberVar();
        AllProgram+="%"+alloca+" = sub i32 %"+t1+", %"+t2+"\n";
        stackNumber.push(alloca);
    ...
    public static void div(){
        ...
        String t2 = (String) stackNumber.pop();
        String alloca = (String) giveMeNumberVar();
        AllProgram+="%"+alloca+" = div i32 %"+t1+", %"+t2+"\n";
        stackNumber.push(alloca);
    ...
    public static void push(){
        ...
        AllProgram+="%"+alloca+" = alloca i32\n";
        AllProgram+="store i32 %" + value +", i32* %"+alloca+"\n";
        AllProgram+="%"+load+" = load i32, i32* %"+alloca+"\n";
        stackNumber.push(load);
